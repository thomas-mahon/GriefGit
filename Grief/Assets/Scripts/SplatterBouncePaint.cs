...
public class SplatterBouncePaint : MonoBehaviour {
    [SerializeField]
    Color32 colorChoice;
    public List<Sprite> sprites; //ref to the sprites which will be used by sprites renderer
    [HideInInspector] public SpriteRenderer spriteRenderer;//ref to sprite renderer component
    [SerializeField]
    BoxCollider2D bouncyFloorPrefab;
    [SerializeField]
